...
export const dependencySelect: Array<PromptObject> = [
  {
    type: 'select',
    name: 'dependency',
    message: 'Select a dependency manager',
    choices: [
      { title: 'yarn', value: 'yarn', description: 'Use yarn dependency manager' },
      { title: 'npm', value: 'npm', description: 'Use npm dependency manager' },
    ],
  },
];
...
export const getGit: Array<PromptObject> = [
  {
    type: 'select',
    name: 'git',
